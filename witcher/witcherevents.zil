...
<ROUTINE QUEST-TALK (QUEST PERSON TEXT GREET REPORT QUEST-TYPE "AUX" UNLOCKED-BY)
	...
	<COND (<VERB? TALK>
		...
		<COND (<OR <IN? .QUEST ,PLAYER> <IN? .QUEST ,CONCEPT-JOURNAL>>
		...
		<COND (<OR <NOT <FSET? ,PRSI ,PERSONBIT>> <NOT <FSET? ,PRSO ,BOUNTYBIT>> <NOT <EQUAL? .QUEST ,PRSO>>>
			...
			<COND (<NOT <IN? .QUEST ,PLAYER>> <NOT <IN? .QUEST ,CONCEPT-JOURNAL>>
				<CRLF>
				<TALK-HIGHLIGHT-PERSON .PERSON .GREET>
				<CRLF>
				<RETURN>
...
<ROUTINE ADD-CLUES (QUEST LOC)
	<COND (<EQUAL? .LOC ,CROSSROADS>
		<POPULATE-CLUES-IN-LOC .LOC .QUEST WHITE-ORCHARD-CLUES>
	)(<EQUAL? .LOC ,WHITE-ORCHARD-FARM>
		<POPULATE-CLUES-IN-LOC .LOC .QUEST FARM-CLUES>
	)(<EQUAL? .LOC ,ABANDONED-VILLAGE-WELL>
		<POPULATE-CLUES-IN-LOC .LOC .QUEST ABANDONED-VILLAGE-CLUES>
	)>>
