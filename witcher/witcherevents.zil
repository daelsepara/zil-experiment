...
<SYNTAX ATTACK OBJECT (IN-ROOM) (FIND MONSTERBIT) WITH OBJECT (HAVE HELD CARRIED) (FIND WEAPONBIT) = V-WITCHER-ATTACK>

<ROUTINE V-WITCHER-ATTACK ()
	<COND (<FSET? ,PRSO ,MONSTERBIT>
		<TELL "You attack the " D ,PRSO " with your " D ,PRSI CR>
		<TELL "It has " N <GETP ,PRSO P?HIT-POINTS> " left " CR>
	)>
>