...
<ROUTINE DESCRIBE-EXITS (LOC)
	...
	<COND (<GETP .LOC ,P?SW> <TELL "Southwest: " D <GETP .LOC ,P?SW> CR>)>
	<COND (<GETP .LOC ,P?SOUTH> <TELL "South: " D <GETP .LOC ,P?SOUTH> CR>)>
	<COND (<GETP .LOC ,P?SE> <TELL "Southeast: " D <GETP .LOC ,P?SE> CR>)>
	<RTRUE>>
