...
<ROUTINE V-CODEX ()
	...
	<COND (<EQUAL? ,PRSO ,SILVER-SWORD>
		<TELL "a weapon for killing creatures of magic." CR>
		<RTRUE>)>
	
	<COND (<EQUAL? ,PRSO ,STEEL-SWORD>
		<TELL "a weapon for killing non-magic creatures." CR>
		<RTRUE>)>
	
	<COND (<EQUAL? ,PRSO ,VAMPIRE-OIL ,SPECTER-OIL ,OGROID-OIL ,NECROPHAGE-OIL ,ELEMENTA-OIL ,HYBRID-OIL ,RELICT-OIL ,DRACONID-OIL ,CURSED-OIL ,HANGEDMANS-VENOM ,INSECTOID-OIL ,BEAST-OIL>
		<TELL "a type of oil for dealing with specific kinds of monsters." CR>
		<RTRUE>)>
		
	<COND (<EQUAL? ,PRSO ,WOLF-MEDALLION>
