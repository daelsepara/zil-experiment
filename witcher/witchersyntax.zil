...
<SYNTAX ATTACK OBJECT (IN-ROOM) (FIND MONSTERBIT) USING OBJECT (HAVE HELD CARRIED) (FIND WEAPONBIT) = V-ATTACK>
...
; Fight to death
<SYNTAX CONTINOUSLY ATTACK OBJECT (FIND MONSTERBIT) (IN-ROOM) WITH OBJECT (FIND WEAPONBIT) (HAVE HELD CARRIED)  = V-RELENTLESS-ASSAULT>
<SYNTAX CONTINOUSLY ATTACK OBJECT (FIND MONSTERBIT) (IN-ROOM) USING OBJECT (FIND WEAPONBIT) (HAVE HELD CARRIED)  = V-RELENTLESS-ASSAULT>
<SYNONYM CONTINOUSLY CONSTANTLY DOGGEDLY ENDLESSLY FURIOUSLY TENACIOUSLY RELENTLESSLY TIRELESSLY UNCEASINGLY UNRELENGTINGLY>
<SYNONYM ATTACK ASSAULT CUT FIGHT HIT STRIKE SLICE>