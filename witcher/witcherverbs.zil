...
<ROUTINE V-READ-CODEX ("AUX" W W2 (STOP FALSE))
	...
	<REPEAT ()
		...
		<COND
			...
			(<OR <EQUAL? .W ,W?GERALT ,W?GWYNBLEIDD ,W?ME, W?MYSELF ,GERALT ,PLAYER> <AND <EQUAL? .W ,W?WHITE> <EQUAL? .W2 ,W?WOLF>>> <PRINT-TOPIC ,TOPIC-GERALT>)
			...
			(<OR <EQUAL? .W ,W?MEDALLION ,W?MEDAL ,WOLF-MEDALLION> <AND <EQUAL? .W ,W?WOLF> <EQUAL? .W2 ,W?MEDALLION ,W?MEDAL>>> <PRINT-TOPIC ,TOPIC-WOLF-MEDALLION>)
