...
<ROOM CAMP-SITE
	(LOC ROOMS)
	(DESC "Campsite")
	(LDESC "A small campfire is burning underneath a tree. All is quiet except for the the crackling sound that keeps the wolves and other would-be predators at bay.")
...
<OBJECT SILVER-SWORD
	...
	(SYNONYM SWORD)
	(ADJECTIVE SILVER)
	(FLAGS TAKEBIT CONTBIT SURFACEBIT OPENBIT)>
