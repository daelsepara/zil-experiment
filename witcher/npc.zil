...
<NPC AMIRA
    (IN MEADOWS)
    (DESC "Amira (Herbalist)")
    (SYNONYM AMIRA HERBALIST)
    (UNLOCKED-BY BOUNTY-WHITE-ORCHARD)
    (ACTION AMIRA-F)
    (FLABGS CONTBIT OPENBIT FEMALEBIT)>

<NPC LENA
    (IN WHITE-ORCHARD-INN)
    (DESC "Lena (Inn Keeper, Bartender)")
    (SYNONYM LENA BARTENDER INNKEEPER)
    (ACTION LENA-F)
    (FLAGS FEMALEBIT)>
...
<ROUTINE LENA-F ()
    <MERCHANT ,LENA <LTABLE EST-EST BOTTLE-OF-DWARVEN-SPIRITS> <LTABLE 100 150>>>

<ROUTINE AMIRA-F ()
    <QUEST-TALK ,QUEST-CURE-FOR-VICTIMS ,AMIRA CURE-FOR-VICTIMS-NEWS CURE-FOR-VICTIMS-GREETINGS CURE-FOR-VICTIMS-REPORT QUEST-RECOVER>>